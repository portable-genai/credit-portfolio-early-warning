...
distinct from this service's own inbound ``CREDITEWS_S2S_TOKEN``.
...
_SERVICE_ACTOR = "credit-portfolio-early-warning"
...
class CloudReviewRouter:
    ...
    def route(self, review: WatchlistReview, *, maker: str, tenant: str = "") -> str:
        ...
        return client.submit(payload, actor=_SERVICE_ACTOR).review_id
