...
@pytest.fixture()
def review_service(container: Container) -> WatchlistReviewService:
    """The REAL service over the REAL local adapters, wired the one way the surfaces wire it."""
...
def api_client() -> Iterator[TestClient]:
    ...
    from credit_portfolio_ews.api.app import app
